		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#tsmxtsmxrestui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tsmxtsmxrestui-display": {
								"semanticObject": "tsmxtsmxrestui",
								"action": "display",
								"description": "Creación de Ordenes",
								"title": "Creación de Ordenes",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tsmx.tsmxrestui",
									"url": sap.ui.require.toUrl("tsmx/tsmxrestui")
								}
							}
						}
					}
