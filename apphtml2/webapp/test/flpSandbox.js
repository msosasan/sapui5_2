		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "DEmo App",
									"targetURL": "#logaligroupapphtml2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligroupapphtml2-display": {
								"semanticObject": "logaligroupapphtml2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.apphtml2",
									"url": sap.ui.require.toUrl("logaligroup/apphtml2")
								}
							}
						}
					}
