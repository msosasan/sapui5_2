		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "DEMO aws API gateway",
									"targetURL": "#tsystemsawsapigateway-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tsystemsawsapigateway-display": {
								"semanticObject": "tsystemsawsapigateway",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tsystems.awsapigateway",
									"url": sap.ui.require.toUrl("tsystems/awsapigateway")
								}
							}
						}
					}
