		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "AWS REST service DEMO",
									"targetURL": "#tsystemsawsapigatewaydemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tsystemsawsapigatewaydemo-display": {
								"semanticObject": "tsystemsawsapigatewaydemo",
								"action": "display",
								"description": "AWS REST service DEMO",
								"title": "AWS REST service DEMO",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tsystems.awsapigatewaydemo",
									"url": sap.ui.require.toUrl("tsystems/awsapigatewaydemo")
								}
							}
						}
					}
