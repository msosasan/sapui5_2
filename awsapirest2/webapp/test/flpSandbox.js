		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#tsystemsawsapirest2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tsystemsawsapirest2-display": {
								"semanticObject": "tsystemsawsapirest2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tsystems.awsapirest2",
									"url": sap.ui.require.toUrl("tsystems/awsapirest2")
								}
							}
						}
					}
