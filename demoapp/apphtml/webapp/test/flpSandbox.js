		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#logaligroupapphtml-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligroupapphtml-display": {
								"semanticObject": "logaligroupapphtml",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.apphtml",
									"url": sap.ui.require.toUrl("logaligroup/apphtml")
								}
							}
						}
					}
