		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Consume REST ABAP service CRUD",
									"targetURL": "#tsystemstsmxabaprest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tsystemstsmxabaprest-display": {
								"semanticObject": "tsystemstsmxabaprest",
								"action": "display",
								"description": "Consume REST ABAP service CRUD",
								"title": "Consume REST ABAP service CRUD",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tsystems.tsmxabaprest",
									"url": sap.ui.require.toUrl("tsystems/tsmxabaprest")
								}
							}
						}
					}
