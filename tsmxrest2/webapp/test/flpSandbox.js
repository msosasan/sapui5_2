		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "DEMO ABAP REST service",
									"targetURL": "#tsystemstsmxrest2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tsystemstsmxrest2-display": {
								"semanticObject": "tsystemstsmxrest2",
								"action": "display",
								"description": "DEMO ABAP REST service",
								"title": "DEMO ABAP REST service",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tsystems.tsmxrest2",
									"url": sap.ui.require.toUrl("tsystems/tsmxrest2")
								}
							}
						}
					}
